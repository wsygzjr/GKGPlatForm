...
{
    class MapCellChartCtlDesigntime : IFunctionalMapCellDesigntime
	{
        private MapCellChartCtlObj mapCellObj;
        private IFunctionalMapCellDesigntimeCallBack iCallBack;

        public MapCellChartCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellChartCtlObj(mapCellID, mapCellName, true);
        }
        ...
        {
            //this.mapCellObj.DeviceStatusIndicatorPropertyModelEdit.TextFont = textFont;
        }
        ...
        {
            //this.mapCellObj.DeviceStatusIndicatorPropertyModelEdit.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
