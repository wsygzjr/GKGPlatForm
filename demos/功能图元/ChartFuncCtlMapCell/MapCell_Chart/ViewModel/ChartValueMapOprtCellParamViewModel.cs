...
{
	public class ChartValueMapOprtCellParamViewModel : ReactiveObject, IDisposable
	{
		...
		public void FromBytes(byte[] data)
		{
			...
			{
				var temp= System.Text.Json.JsonSerializer.Deserialize<ChartValueMapOprtCellParamViewModel>(Encoding.UTF8.GetString(data));
