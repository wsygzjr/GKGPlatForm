...
{
    class MapCellAuxiliaryFunctionsCtlDesigntime : IFunctionalMapCellDesigntime
    {
        private MapCellAuxiliaryFunctionsCtlObj mapCellObj;
        private IFunctionalMapCellDesigntimeCallBack iCallBack;

        public MapCellAuxiliaryFunctionsCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellAuxiliaryFunctionsCtlObj(mapCellID, mapCellName, true);
        }
        ...
        {
            this.mapCellObj.AuxiliaryFunctionsPropertyModelEdit.TextFont = textFont;
        }
        ...
        {
            this.mapCellObj.AuxiliaryFunctionsPropertyModelEdit.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
