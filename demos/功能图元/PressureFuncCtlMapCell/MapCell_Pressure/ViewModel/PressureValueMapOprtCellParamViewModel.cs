...
{
	public class PressureValueMapOprtCellParamViewModel : ReactiveObject, IDisposable
	{
		...
		public void FromBytes(byte[] data)
		{
			...
			{
				var temp= System.Text.Json.JsonSerializer.Deserialize<PressureValueMapOprtCellParamViewModel>(Encoding.UTF8.GetString(data));
