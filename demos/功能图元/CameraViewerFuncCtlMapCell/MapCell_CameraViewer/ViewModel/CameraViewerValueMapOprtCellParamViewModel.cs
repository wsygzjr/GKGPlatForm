...
{
	public class CameraViewerValueMapOprtCellParamViewModel : ReactiveObject, IDisposable
	{
		...
		public void FromBytes(byte[] data)
		{
			...
			{
				var temp= System.Text.Json.JsonSerializer.Deserialize<CameraViewerValueMapOprtCellParamViewModel>(Encoding.UTF8.GetString(data));
