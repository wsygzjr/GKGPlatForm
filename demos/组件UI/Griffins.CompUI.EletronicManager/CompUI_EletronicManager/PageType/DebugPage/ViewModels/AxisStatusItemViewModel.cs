...
namespace Griffins.CompUI.EletronicManager.CompUI_EletronicManager.PageType.DebugPage.ViewModels
{
    ...
    {
        private int _backendAxisNo = -1;
        public int BackendAxisNo
        {
            get => _backendAxisNo;
            set => this.RaiseAndSetIfChanged(ref _backendAxisNo, value);
        }
        ...
        private Guid _cardGuid = Guid.Empty;
        public Guid CardGuid
        {
            get => _cardGuid;
            set => this.RaiseAndSetIfChanged(ref _cardGuid, value);
        }
