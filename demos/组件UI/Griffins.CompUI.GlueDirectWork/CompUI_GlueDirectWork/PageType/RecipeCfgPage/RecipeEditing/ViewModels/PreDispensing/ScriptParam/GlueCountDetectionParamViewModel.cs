...
namespace Griffins.CompUI.GlueDirectWork.PageType.RecipeCfgPage.RecipeEditing.ViewModels
{
    ...
    /// 胶点个数界面-视图模型
    /// </summary>
    public class GlueCountDetectionParamViewModel : ReactiveObject
    {
        #region 私有字段（数据源）
        ...
        /// 构造方法（初始化组件、默认值）
        /// </summary>
        public GlueCountDetectionParamViewModel()
        {
            #region 初始化UI组件模型
        ...
        /// 从数据模型复制数据到ViewModel
        /// </summary>
        public void CopyFrom(GlueCountDetectionCfgInfo model)
        {
        ...
        /// 从ViewModel复制数据到数据模型
        /// </summary>
        public void CopyTo(GlueCountDetectionCfgInfo model)
        {
