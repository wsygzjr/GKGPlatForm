...
public partial class TwoDDetectionProgrammingWindow : Window
{
    public TwoDDetectionProgrammingWindow()
    {
        InitializeComponent();
        // 监听 ViewModel 的 DialogResult 变化
        this.WhenAnyValue(x => x.DataContext!)
            .Where(ctx => ctx is TwoDDetectionProgrammingWindowViewModel)
            .Cast<TwoDDetectionProgrammingWindowViewModel>()
            .Subscribe(vm =>
            {
