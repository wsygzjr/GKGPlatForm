...
namespace GKG.UI.General
{
    ...
    /// 温度控制串口调试-视图模型
    /// </summary>
    public class TemperatureSerialPortViewModel : ReactiveObject
    {
        #region 私有字段
        ...
        /// 构造函数
        /// </summary>
        public TemperatureSerialPortViewModel()
        {
            #region 初始化UI属性
            ...
            var baudRateDisplayNames = new Dictionary<SerialPortCfgTypes.BaudRate, string>// 波特率
            {
            ...
            var dataBitsDisplayNames = new Dictionary<SerialPortCfgTypes.DataBits, string>// 数据位
            {
            ...
            var stopBitsDisplayNames = new Dictionary<SerialPortCfgTypes.StopBits, string>// 停止位
            {
            ...
            var parityDisplayNames = new Dictionary<SerialPortCfgTypes.Parity, string>// 校验类型
            {
        ...
        /// 从配置模型复制数据到ViewModel
        /// </summary>
        public void CopyFrom(TemperatureSerialPortCfg model)
        {
        ...
        /// 从ViewModel复制数据到配置模型
        /// </summary>
        public void CopyTo(TemperatureSerialPortCfg model)
        {
            if (model == null) return;
