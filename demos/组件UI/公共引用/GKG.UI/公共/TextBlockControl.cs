...
namespace GKG.UI
{
    ...
    /// 带标题的文本显示控件
    /// </summary>
    public class TextBlockControl : BasicControl<TextBlockViewModel>
    {
        private TextBlock? _innerTextBox; 

        /// <summary>
        /// 
        /// </summary>
        public TextBlockControl() : base()
        {
            initializeTextBox();
        }
    ...
    /// 文本输入框-视图模型
    /// </summary>
    public class TextBlockViewModel : BasicControlViewModel
    {
