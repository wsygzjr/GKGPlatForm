...
namespace Griffins.CompUI.GD.InitCfgPage
{
    internal class SingleTrackStationPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        ...
        public SingleTrackStationPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
            ...
            view = new SingleTrackStationCompUIView();
        ...
        {
            singleTrackStationCompUIModel = compUIModel ?? new SingleTrackStationCompUIModel();
        }
        ...
        {
            singleTrackStationCompUIModel ??= new SingleTrackStationCompUIModel();

            // 赋值
            singleTrackStationCompUIModel.GearSpeedList = new(
                viewModel.GearSpeedList!.Select(item => new TrackItemModel
                {
            ...
            singleTrackStationCompUIModel.SupportShadowStation = viewModel.SupportShadowStation;
            singleTrackStationCompUIModel.EnableProximitySensor = viewModel.EnableProximitySensor;
            singleTrackStationCompUIModel.EnableBoardJamSignal = viewModel.EnableBoardJamSignal;

            return singleTrackStationCompUIModel;
        }
        ...
        {
            if (e.PropertyName == nameof(viewModel.GearSpeedList))
            {
