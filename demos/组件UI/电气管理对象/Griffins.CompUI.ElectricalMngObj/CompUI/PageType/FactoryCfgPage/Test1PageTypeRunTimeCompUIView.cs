...
{
	internal class Test1PageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
	{
		private ICompUIRunTimeCallBack callBack;

		private event EventHandler afterModified;

		private Test1FactoryCfgCompUIView view;

		private Test1FactoryCfgCompUIViewModel viewModel;

		public Test1PageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
		{
			this.callBack = callBack;
			view = new Test1FactoryCfgCompUIView();
			viewModel = new Test1FactoryCfgCompUIViewModel(false, this.callBack);
		...
		private Test1FactoryCfgCompUIModel testFactoryCfgCompUIModel;
		public void SetData(Test1FactoryCfgCompUIModel testFactoryCfgCompUIModel) 
		{
			if (testFactoryCfgCompUIModel == null)
				testFactoryCfgCompUIModel = new Test1FactoryCfgCompUIModel();

            this.testFactoryCfgCompUIModel = testFactoryCfgCompUIModel;
			viewModel.Text= testFactoryCfgCompUIModel.Text;
		}

		public Test1FactoryCfgCompUIModel GetData()
		{
			if (this.testFactoryCfgCompUIModel == null)
				this.testFactoryCfgCompUIModel = new Test1FactoryCfgCompUIModel();
			this.testFactoryCfgCompUIModel.Text = viewModel.Text;
			return testFactoryCfgCompUIModel;
		}
	}
}
