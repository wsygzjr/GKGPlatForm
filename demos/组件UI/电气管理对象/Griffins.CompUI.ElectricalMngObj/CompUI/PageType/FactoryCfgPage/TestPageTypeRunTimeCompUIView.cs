...
namespace Griffins.CompUI.ElectricalMngObj.FactoryCfgPage
{
	internal class TestPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
	{
		...
		private TestFactoryCfgCompUIView view;

		private TestFactoryCfgCompUIViewModel viewModel;

		public TestPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
		{
			this.callBack = callBack;
			view = new TestFactoryCfgCompUIView();
			viewModel = new TestFactoryCfgCompUIViewModel(false, this.callBack);
		...
		private TestFactoryCfgCompUIModel testFactoryCfgCompUIModel;
		public void SetData(TestFactoryCfgCompUIModel testFactoryCfgCompUIModel) 
		{
            if (testFactoryCfgCompUIModel == null)
                testFactoryCfgCompUIModel = new TestFactoryCfgCompUIModel();

            this.testFactoryCfgCompUIModel = testFactoryCfgCompUIModel;
            viewModel.Text= testFactoryCfgCompUIModel.Text;
		}

		public TestFactoryCfgCompUIModel GetData()
		{
			if (this.testFactoryCfgCompUIModel == null)
				this.testFactoryCfgCompUIModel = new TestFactoryCfgCompUIModel();
