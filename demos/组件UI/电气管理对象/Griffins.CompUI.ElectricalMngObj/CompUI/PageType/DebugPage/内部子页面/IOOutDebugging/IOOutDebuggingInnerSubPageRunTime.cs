...
using DispensingPageType.Views.DebuggingPage.IOOutDebugging;
using DispensingPageType.Views.DebuggingPage.IOOutDebugging;
...
{
    /// <summary>
    /// IOOUT调试配置内部子页面运行时接口实现对象
    /// </summary>
    public class IOOutDebuggingInnerSubPageRunTime : IInnerSubPageRunTime
    {
        private IOOutDebuggingSubPageViewModel _iOOutDebuggingSubPageViewModel;
        ...
        /// 构造函数
        /// </summary>
        public IOOutDebuggingInnerSubPageRunTime()
        {
            _iOOutDebuggingSubPageViewModel = new IOOutDebuggingSubPageViewModel();
        }
        /// <summary>
        /// 初始化
        /// </summary>
        ...
        object ISubPageRunTime.View
        {
            get
            {
                var iOOutDebuggingSubPageView = new IOOutDebuggingSubPageView();
                iOOutDebuggingSubPageView.DataContext = _iOOutDebuggingSubPageViewModel;
                _iOOutDebuggingSubPageViewModel.SetViewReference(iOOutDebuggingSubPageView);
                return iOOutDebuggingSubPageView;
            }
        }
        /// <summary>
        /// 设置内部子页面配置信息
        ...
        {
            //_iOOutDebuggingSubPageViewModel.Init(data);
        }
        /// <summary>
        /// 获取数据信息，null表示缺省值
        /// </summary>
        ...
        {
            return null;
            //return _iOOutDebuggingSubPageViewModel.CfgInfo;
        }
