...
namespace Griffins.CompUI.ElectricalMngObj.DebugPage
{
	internal class DebugPageTypeRunTimeCompUI : PageTypeRunTimeCompUIBase
	{
        ...
        private AxisDebuggingInnerSubPageRunTime axisDebuggingInnerSubPageRunTime = new();
        private IOInDebuggingInnerSubPageRunTime iOInDebuggingInnerSubPageRunTime = new();
        private IOOutDebuggingInnerSubPageRunTime iOOutDebuggingInnerSubPageRunTime = new();
        /// <summary>
        /// 初始化
        /// </summary>
        protected override void _OnInit()
        {
            ...
            axisDebuggingInnerSubPageRunTime.Init(base.CallBack);
            iOInDebuggingInnerSubPageRunTime.Init(base.CallBack);
            iOOutDebuggingInnerSubPageRunTime.Init(base.CallBack);
        }
        ...
        protected override ISubPageRunTime _GetSubPageRunTime(SubPageKindInfoBase subPageKindInfo)
        {
            ...
            {
                case AxisDebuggingSubPageInfoDef.InnerSubPageTypeIDStr:
                    return axisDebuggingInnerSubPageRunTime;
                case IOInDebuggingSubPageInfoDef.InnerSubPageTypeIDStr:
                    return iOInDebuggingInnerSubPageRunTime;
                case IOOutDebuggingSubPageInfoDef.InnerSubPageTypeIDStr:
                    return iOOutDebuggingInnerSubPageRunTime;
                default:
