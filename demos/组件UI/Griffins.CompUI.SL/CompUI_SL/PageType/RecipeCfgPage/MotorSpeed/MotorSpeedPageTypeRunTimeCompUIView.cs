...
{
    internal class MotorSpeedPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        private ICompUIRunTimeCallBack callBack;

        private event EventHandler afterModified;

        private MotorSpeedCompUIView view;

        private readonly MotorSpeedCompUIViewModel viewModel;

        private MotorSpeedCompUIModel‌ motorSpeedCompUIModel‌;
        ...
        public MotorSpeedPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
        ...
        /// 设置数据
        /// </summary>
        /// <param name="motorSpeedCompUIModel‌"></param>
        public void SetData(MotorSpeedCompUIModel‌ motorSpeedCompUIModel‌)
        {
            this.motorSpeedCompUIModel‌ = motorSpeedCompUIModel‌ ?? new MotorSpeedCompUIModel‌();
        ...
        public MotorSpeedCompUIModel‌ GetData()
        {
            if (this.motorSpeedCompUIModel‌ == null)
            {
                this.motorSpeedCompUIModel‌ = new MotorSpeedCompUIModel‌();
            }
            this.motorSpeedCompUIModel‌.FrontMotorSpeed = viewModel.FrontMotorSpeed;
            this.motorSpeedCompUIModel‌.BehindMotorSpeed = viewModel.BehindMotorSpeed;
            return motorSpeedCompUIModel‌;
        }
        ...
        {
            if (e.PropertyName == nameof(viewModel.FrontMotorSpeed))
            {
                afterModified?.Invoke(sender, null);
            }
            else if (e.PropertyName == nameof(viewModel.BehindMotorSpeed))
            {
                afterModified?.Invoke(sender, null);
            }
        }
