...
{
    internal class TransportMotorPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        private ICompUIRunTimeCallBack callBack;

        private event EventHandler afterModified;

        private TransportMotorCompUIView view;

        private readonly TransportMotorCompUIViewModel viewModel;

        private TransportMotorCompUIModel transportMotorCompUIModel;
        ...
        public TransportMotorPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
        ...
        public void SetData(TransportMotorCompUIModel transportMotorCompUIModel)
        {
            this.transportMotorCompUIModel = transportMotorCompUIModel ?? new TransportMotorCompUIModel();
            viewModel.SetData(transportMotorCompUIModel);
        }
        ...
        {
            foreach (var motor in viewModel.Motors)
            {
        ...
        {
            if (e.PropertyName == nameof(viewModel.Motors))
            {
