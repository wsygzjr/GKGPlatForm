...
{
    internal class PcCommunicationPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        private ICompUIRunTimeCallBack callBack;

        private event EventHandler afterModified;

        private PcCommunicationCompUIView view;

        private readonly PcCommunicationCompUIViewModel viewModel;

        private PcCommunicationCompUIModel pcCommunicationCompUIModel;
        ...
        public PcCommunicationPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
        ...
        /// 设置数据
        /// </summary>
        /// <param name="transportMotorCompUIModel"></param>
        public void SetData(PcCommunicationCompUIModel pcCommunicationCompUIModel)
        {
            this.pcCommunicationCompUIModel = pcCommunicationCompUIModel ?? new PcCommunicationCompUIModel();
        ...
        public PcCommunicationCompUIModel GetData()
        {
            if (this.pcCommunicationCompUIModel == null)
            {
                this.pcCommunicationCompUIModel = new PcCommunicationCompUIModel();
            }
            this.pcCommunicationCompUIModel.UpperCommunication = viewModel.UpperCommunication;
            this.pcCommunicationCompUIModel.SlaveCommunication = viewModel.SlaveCommunication;
            this.pcCommunicationCompUIModel.SupSMEMA = viewModel.SupSMEMA;
            return pcCommunicationCompUIModel;
        }
        ...
        {
            if (e.PropertyName == nameof(viewModel.UpperCommunication))
            {
                afterModified?.Invoke(sender, null);
            }
            else if (e.PropertyName == nameof(viewModel.SlaveCommunication))
            {
                afterModified?.Invoke(sender, null);
            }
            else if (e.PropertyName == nameof(viewModel.SupSMEMA))
            {
                afterModified?.Invoke(sender, null);
            }
        }
