...
{
    internal class TrackBasicParamPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        private ICompUIRunTimeCallBack callBack;

        private event EventHandler afterModified;

        private TrackBasicParamCompUIView view;

        private readonly TrackBasicParamCompUIViewModel viewModel;

        private TrackBasicParamCompUIModel trackBasicParamCompUIModel;
        ...
        public TrackBasicParamPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
        ...
        /// 设置数据
        /// </summary>
        /// <param name="TrackBasicParamCompUIModel"></param>
        public void SetData(TrackBasicParamCompUIModel trackBasicParamCompUIModel)
        {
            this.trackBasicParamCompUIModel = trackBasicParamCompUIModel ?? new TrackBasicParamCompUIModel();
        ...
        public TrackBasicParamCompUIModel GetData()
        {
            if (this.trackBasicParamCompUIModel == null)
            {
                this.trackBasicParamCompUIModel = new TrackBasicParamCompUIModel();
            }
            this.trackBasicParamCompUIModel.RefluxNoBoard = viewModel.RefluxNoBoard;
            this.trackBasicParamCompUIModel.SlavePriority = viewModel.SlavePriority;
            return trackBasicParamCompUIModel;
        }
        ...
        {
            if (e.PropertyName == nameof(viewModel.RefluxNoBoard))
            {
                afterModified?.Invoke(sender, null);
            }
            else if (e.PropertyName == nameof(viewModel.SlavePriority))
            {
                afterModified?.Invoke(sender, null);
            }
        }
