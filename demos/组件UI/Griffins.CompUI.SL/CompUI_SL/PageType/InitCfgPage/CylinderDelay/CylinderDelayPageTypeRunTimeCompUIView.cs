...
{
    /// <summary>
    /// CylinderDelayPageTypeRunTimeCompUIView 类
    /// </summary>
    internal class CylinderDelayPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
    {
        #region 私有字段
        ...
        private CylinderDelayCompUIView view;

        private readonly CylinderDelayCompUIViewModel viewModel;
        ...
        public CylinderDelayPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
        {
        ...
        /// 设置数据
        /// </summary>
        /// <param name="cylinderDelayCompUIModel"></param>
        public void SetData(CylinderDelayCompUIModel cylinderDelayCompUIModel)
        {
            this.cylinderDelayCompUIModel = cylinderDelayCompUIModel ?? new CylinderDelayCompUIModel();
            viewModel.SetData(this.cylinderDelayCompUIModel);
        }
        ...
        {
            if (e.PropertyName == nameof(viewModel.CylinderDelay))
            {
