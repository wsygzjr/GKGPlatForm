...
namespace Griffins.CompUI.TestGlueDirectWorkMM.InitCfgPage.ViewModel
{
	public class Test1InitCfgCompUIViewModel : ReactiveObject, IDisposable
	{
		...
		public Test1InitCfgCompUIViewModel(bool isDesign, ICompUIRunTimeCallBack callBack)
		{
