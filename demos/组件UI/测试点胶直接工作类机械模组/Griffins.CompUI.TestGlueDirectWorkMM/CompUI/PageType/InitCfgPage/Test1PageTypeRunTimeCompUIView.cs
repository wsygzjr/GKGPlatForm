...
namespace Griffins.CompUI.TestGlueDirectWorkMM.InitCfgPage
{
	internal class Test1PageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
	{
		...
		private Test1InitCfgCompUIView view;

		private Test1InitCfgCompUIViewModel viewModel;

		public Test1PageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
		{
			this.callBack = callBack;
			view = new Test1InitCfgCompUIView();
			viewModel = new Test1InitCfgCompUIViewModel(false, this.callBack);
		...
		private Test1InitCfgCompUIModel testInitCfgCompUIModel;
		public void SetData(Test1InitCfgCompUIModel testInitCfgCompUIModel) 
		{
			if (testInitCfgCompUIModel == null)
				testInitCfgCompUIModel = new Test1InitCfgCompUIModel();

            this.testInitCfgCompUIModel = testInitCfgCompUIModel;
			viewModel.Text= testInitCfgCompUIModel.Text;
		}

		public Test1InitCfgCompUIModel GetData()
		{
			if (this.testInitCfgCompUIModel == null)
				this.testInitCfgCompUIModel = new Test1InitCfgCompUIModel();
			this.testInitCfgCompUIModel.Text = viewModel.Text;
			return testInitCfgCompUIModel;
		}
	}
}
