...
namespace Griffins.CompUI.TestGlueDirectWorkMM.InitCfgPage
{
	internal class TestPageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
	{
		...
		private TestInitCfgCompUIView view;

		private TestInitCfgCompUIViewModel viewModel;

		public TestPageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
		{
			this.callBack = callBack;
			view = new TestInitCfgCompUIView();
			viewModel = new TestInitCfgCompUIViewModel(false, this.callBack);
		...
		private TestInitCfgCompUIModel testInitCfgCompUIModel;
		public void SetData(TestInitCfgCompUIModel testInitCfgCompUIModel) 
		{
            if (testInitCfgCompUIModel == null)
                testInitCfgCompUIModel = new TestInitCfgCompUIModel();

            this.testInitCfgCompUIModel = testInitCfgCompUIModel;
            viewModel.Text= testInitCfgCompUIModel.Text;
		}

		public TestInitCfgCompUIModel GetData()
		{
			if (this.testInitCfgCompUIModel == null)
				this.testInitCfgCompUIModel = new TestInitCfgCompUIModel();
