...
namespace Griffins.CompUI.TestGlueDirectWorkMM.RecipeCfgPage
{
	internal class Test1PageTypeRunTimeCompUIView : IPageTypeRunTimeCompUIView
	{
		...
		private Test1RecipeCfgCompUIView view;

		private Test1RecipeCfgCompUIViewModel viewModel;

		public Test1PageTypeRunTimeCompUIView(ICompUIRunTimeCallBack callBack)
		{
			this.callBack = callBack;
			view = new Test1RecipeCfgCompUIView();
			viewModel = new Test1RecipeCfgCompUIViewModel(false, this.callBack);
		...
		private Test1RecipeCfgCompUIModel testRecipeCfgCompUIModel;
		public void SetData(Test1RecipeCfgCompUIModel testRecipeCfgCompUIModel) 
		{
			if (testRecipeCfgCompUIModel == null)
				testRecipeCfgCompUIModel = new Test1RecipeCfgCompUIModel();

            this.testRecipeCfgCompUIModel = testRecipeCfgCompUIModel;
			viewModel.Text= testRecipeCfgCompUIModel.Text;
		}

		public Test1RecipeCfgCompUIModel GetData()
		{
			if (this.testRecipeCfgCompUIModel == null)
				this.testRecipeCfgCompUIModel = new Test1RecipeCfgCompUIModel();
