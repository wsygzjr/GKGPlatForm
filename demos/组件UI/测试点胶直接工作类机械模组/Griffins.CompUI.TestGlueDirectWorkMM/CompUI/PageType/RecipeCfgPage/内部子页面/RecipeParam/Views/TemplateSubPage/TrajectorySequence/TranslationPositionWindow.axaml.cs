...
public partial class TranslationPositionWindow : Window
{
    public TranslationPositionWindow()
    {
        InitializeComponent();
        // 监听 ViewModel 的 DialogResult 变化
        this.WhenAnyValue(x => x.DataContext!)
            .Where(ctx => ctx is TranslationPositionViewModel)
            .Cast<TranslationPositionViewModel>()
            .Subscribe(vm =>
            {
