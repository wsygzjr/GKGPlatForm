...
namespace Griffins.CompUI.TestGlueDirectWorkMM.RecipeCfgPage.ViewModels.Plan
{
    ...
    /// 选择区域弹窗-视图模型
    /// </summary>
    public class SelectAreaWindowViewModel :
        DataGridListBaseViewModel<AreaItemViewModel, AreaInfo>
    {
        ...
        /// 构造函数
        /// </summary>
        public SelectAreaWindowViewModel() :base()
        {
            SaveCommand = ReactiveCommand.Create(save);
            CancelCommand = ReactiveCommand.Create(cancel);
            this.ItemsSource.Clear();
            if(CacheDataExchange.AreaListViewModel!=null)
                this.ItemsSource.AddRange(CacheDataExchange.AreaListViewModel.ItemsSource.ToList());
        }
        ...
        /// 单条删除
        /// </summary>
        protected override async Task<bool> _deleteItem(AreaItemViewModel areaItemViewModel)
        {
            throw new Exception("不支持的操作");
        }
        #endregion
