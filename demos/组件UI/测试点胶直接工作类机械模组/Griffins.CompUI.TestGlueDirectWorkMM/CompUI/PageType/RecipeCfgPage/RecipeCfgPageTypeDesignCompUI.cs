...
namespace Griffins.CompUI.TestGlueDirectWorkMM.RecipeCfgPage
{
	internal class RecipeCfgPageTypeDesignCompUI: PageTypeDesignCompUIbase
	{
		...
		{			
			...
			{
				new PageTypeCompUIViewInfo() { ViewID = RecipeCfgPageTypeConst.ViewID_Test, ViewName = ResourceA.ViewName_Test },
				new PageTypeCompUIViewInfo() { ViewID = RecipeCfgPageTypeConst.ViewID_Test1, ViewName = ResourceA.ViewzName_Test1 }
			};
		}
        /// <summary>
        ...
        protected override object _GetPageTypeCompUIView(string viewID)
		{
			switch (viewID)
			{
				case RecipeCfgPageTypeConst.ViewID_Test:
					return new TestRecipeCfgCompUIView();
				case RecipeCfgPageTypeConst.ViewID_Test1:
					return new Test1RecipeCfgCompUIView();
				default:
        ...
        protected override InnerSubPageTypeInfoList _GetInnerSubPageTypeInfoes()
		{
            ...
            controlCardInnerSubPageTypeInfo.ID = PPCfgSubPageInfoDef.InnerSubPageTypeID;
            controlCardInnerSubPageTypeInfo.Name = PPCfgSubPageInfoDef.InnerSubPageTypeName;
