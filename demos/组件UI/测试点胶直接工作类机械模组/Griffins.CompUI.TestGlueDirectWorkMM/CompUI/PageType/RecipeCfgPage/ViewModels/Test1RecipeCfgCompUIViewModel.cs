...
{
	public class Test1RecipeCfgCompUIViewModel : ReactiveObject, IDisposable
	{
		...
		public Test1RecipeCfgCompUIViewModel(bool isDesign, ICompUIRunTimeCallBack callBack)
		{
