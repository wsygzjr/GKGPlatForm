...
namespace Griffins.CompUI.TestGlueDirectWorkMM.DebugPage.ViewModel
{
	public class TestDebugCompUIViewModel : ReactiveObject, IDisposable
	{
		...
		public TestDebugCompUIViewModel(bool isDesign, ICompUIRunTimeCallBack callBack)
		{
