...
namespace Griffins.CompUI.TestGlueDirectWorkMM.FactoryCfgPage.ViewModel
{
	public class TestFactoryCfgCompUIViewModel : ReactiveObject, IDisposable
	{
		...
		public TestFactoryCfgCompUIViewModel(bool isDesign, ICompUIRunTimeCallBack callBack)
		{
