using GF_Gereric;
using GKG.SubMM;
using Griffins.CompUI.CategoryARobot.CompUI_CategoryARobot.PageType.InitCfgPage.MechanicalArm;
...
namespace Griffins.CompUI.CategoryARobot.CompUI_CategoryARobot.PageType.InitCfgPage
{
    internal class InitCfgPageTypeRunTimeCompUI : PageTypeRunTimeCompUIBase
    {
        ...
        private CategoryARobotSubMachineModulesInitCfg data;

        protected override void _OnInit()
        {
            data = new CategoryARobotSubMachineModulesInitCfg();
        }
        ...
        protected override void _SetData(byte[] dataBytes)
        {
            ...
            data = JsonObjConvert.FromJSonBytes<CategoryARobotSubMachineModulesInitCfg>(dataBytes) ?? new CategoryARobotSubMachineModulesInitCfg();
            (mechanicalArmView as MechanicalArmPageTypeRunTimeCompUIView)?.SetData(data);
        }
