...
namespace GKG.Map.MapCell.Generic.Control.MapCell_ImageGroup.MapOprtCellParamCfgView
{
    internal static class ImageGroupOprtCellCfgJson
    {
    ...
    internal sealed class AppearanceInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        {
            var temp = ImageGroupOprtCellCfgJson.FromBytes<AppearanceInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            Opacity = temp.Opacity ?? Opacity;
        }
        public byte[] ToBytes() => ImageGroupOprtCellCfgJson.ToBytes(this);
    }

    internal sealed class CommonInfoMapOprtCellParamViewModel : ReactiveObject
    {
        private int? _currentIndex;
        public int? CurrentIndex { get => _currentIndex; set => this.RaiseAndSetIfChanged(ref _currentIndex, value); }
        private ImageGroupStretchMode? _stretchMode;
        public ImageGroupStretchMode? StretchMode { get => _stretchMode; set => this.RaiseAndSetIfChanged(ref _stretchMode, value); }
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ImageGroupOprtCellCfgJson.FromBytes<CommonInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class LayoutInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ImageGroupOprtCellCfgJson.FromBytes<LayoutInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class CurrentIndexMapOprtCellParamViewModel : ReactiveObject
    {
        private int? _currentIndex;
        public int? CurrentIndex { get => _currentIndex; set => this.RaiseAndSetIfChanged(ref _currentIndex, value); }
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ImageGroupOprtCellCfgJson.FromBytes<CurrentIndexMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            CurrentIndex = temp.CurrentIndex;
        }
        public byte[] ToBytes() => ImageGroupOprtCellCfgJson.ToBytes(this);
    ...
    internal abstract class ImageGroupOprtCellParamViewBase : AControls.UserControl
    {
        ...
        {
            var nud = new AControls.NumericUpDown { Width = width, Minimum = 0 };
    ...
    internal sealed class AppearanceInfoMapOprtCellParamView : ImageGroupOprtCellParamViewBase
    {
    ...
    internal sealed class CommonInfoMapOprtCellParamView : ImageGroupOprtCellParamViewBase
    {
        public CommonInfoMapOprtCellParamView()
        {
            var root = CreateRoot();
            root.Children.Add(CreateRow("当前索引", CreateNumericUpDown(nameof(CommonInfoMapOprtCellParamViewModel.CurrentIndex), 80)));
            root.Children.Add(CreateRow("填充方式", CreateNullableEnumComboBox<ImageGroupStretchMode>(nameof(CommonInfoMapOprtCellParamViewModel.StretchMode))));
    ...
    internal sealed class LayoutInfoMapOprtCellParamView : ImageGroupOprtCellParamViewBase
    {
    ...
    internal sealed class CurrentIndexMapOprtCellParamView : ImageGroupOprtCellParamViewBase
    {
        public CurrentIndexMapOprtCellParamView()
        {
            var root = CreateRoot();
            root.Children.Add(CreateRow("当前索引", CreateNumericUpDown(nameof(CurrentIndexMapOprtCellParamViewModel.CurrentIndex), 80)));
            Content = root;
        }
    }
    ...
    internal sealed class CurrentIndexMapOprtCellParamCfgView : IMapOprtCellParamCfgView
    {
        private readonly CurrentIndexMapOprtCellParamView _view;
        private readonly CurrentIndexMapOprtCellParamViewModel _vm;
        public CurrentIndexMapOprtCellParamCfgView() { _vm = new(); _view = new() { DataContext = _vm }; }
        public object View => _view;
        public void SetData(byte[] data) => _vm.FromBytes(data);
        public byte[] GetData() => _vm.ToBytes();
        object IMapOprtCellParamCfgView.View => View;
