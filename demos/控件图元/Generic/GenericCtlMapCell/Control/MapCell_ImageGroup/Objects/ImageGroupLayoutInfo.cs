...
namespace GKG.Map.MapCell.Generic.Control.MapCell_ImageGroup.Objects
{
    ...
    public class ImageGroupLayoutInfo : MiniReactiveObject, IJsonValueConvert, IMPPropObjectValue
    {
        #region 静态字段

        public static readonly ImageGroupLayoutInfo Default = new ImageGroupLayoutInfo();
        public static readonly Guid Object_ID = new Guid("{D3C4E5F6-2003-4001-9001-000000000003}");
        ...
        public ImageGroupLayoutInfo()
            : this(HorizontalAlignType.Stretch, VerticalAlignType.Stretch,
                   0, 0, 0, 0, 0, 0, 0, 0)
        {
        }

        public ImageGroupLayoutInfo(HorizontalAlignType horizontalAlign, VerticalAlignType verticalAlign,
        ...
        public void CopyFrom(ImageGroupLayoutInfo source)
        {
