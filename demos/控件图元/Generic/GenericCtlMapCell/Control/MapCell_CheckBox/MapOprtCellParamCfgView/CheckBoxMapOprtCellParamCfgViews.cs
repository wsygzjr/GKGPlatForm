...
namespace GKG.Map.MapCell.Generic.CheckBox.MapOprtCellParamCfgView
{
    internal static class CheckBoxOprtCellCfgJson
    {
    ...
    internal sealed class BrushInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        {
            var temp = CheckBoxOprtCellCfgJson.FromBytes<BrushInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            BackColor = temp.BackColor ?? BackColor;
            BorderColor = temp.BorderColor ?? BorderColor;
            ForeColor = temp.ForeColor ?? ForeColor;
        }
        public byte[] ToBytes() => CheckBoxOprtCellCfgJson.ToBytes(this);
    }
    ...
    internal sealed class AppearanceInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = CheckBoxOprtCellCfgJson.FromBytes<AppearanceInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class LayoutInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = CheckBoxOprtCellCfgJson.FromBytes<LayoutInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class CommonInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = CheckBoxOprtCellCfgJson.FromBytes<CommonInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            Text = temp.Text ?? Text;
    ...
    internal sealed class TextInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = CheckBoxOprtCellCfgJson.FromBytes<TextInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal abstract class CheckBoxOprtCellParamViewBase : AControls.UserControl
    {
    ...
    internal sealed class BrushInfoMapOprtCellParamView : CheckBoxOprtCellParamViewBase
    {
    ...
    internal sealed class AppearanceInfoMapOprtCellParamView : CheckBoxOprtCellParamViewBase
    {
    ...
    internal sealed class LayoutInfoMapOprtCellParamView : CheckBoxOprtCellParamViewBase
    {
    ...
    internal sealed class CommonInfoMapOprtCellParamView : CheckBoxOprtCellParamViewBase
    {
    ...
    internal sealed class TextInfoMapOprtCellParamView : CheckBoxOprtCellParamViewBase
    {
