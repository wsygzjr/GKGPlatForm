...
{
    class MapCellCheckBoxCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellCheckBoxCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellCheckBoxCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellCheckBoxCtlObj(mapCellID, mapCellName, true);
        }
        ...
        {
            this.mapCellObj.CheckBoxPropertyModelEdit.TextInfo.FontColor = textColor;
        }
