...
namespace GKG.Map.MapCell.Generic.CheckBox
{
    ...
    public class CheckBoxLayoutInfo : MiniReactiveObject, IJsonValueConvert, IMPPropObjectValue
    {
        public static readonly CheckBoxLayoutInfo Default = new CheckBoxLayoutInfo();
        public static readonly Guid Object_ID = new Guid("{D2B2C3D4-3333-4AC8-BF66-281412CDE303}");
        ...
        public CheckBoxLayoutInfo()
            : this(HorizontalAlignType.Stretch, VerticalAlignType.Stretch, 0, 0, 0, 0, 0, 0, 0, 0)
        {
        }

        public CheckBoxLayoutInfo(HorizontalAlignType horizontalAlign, VerticalAlignType verticalAlign,
        ...
        void IMPPropObjectValue.PopulateFromBaseValue(GriffinsBaseValue baseValue)
        {
            if (baseValue != null && baseValue.Val != null)
            {
                if (!(baseValue.Val is ObjectValue_Json))
                    throw new Exception("对象值不是CheckBoxLayoutInfo转换的");
