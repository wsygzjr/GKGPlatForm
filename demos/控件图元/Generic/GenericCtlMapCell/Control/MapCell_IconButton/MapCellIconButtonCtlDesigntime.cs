...
namespace GKG.Map.MapCell.Generic.Control.MapCell_IconButton
{
    class MapCellIconButtonCtlDesigntime : IControlMapCellDesigntime
    {
        ...
        {
            mapCellObj = new MapCellIconButtonCtlObj(mapCellID, mapCellName);
        }
        ...
        {
            mapCellObj.IconButtonPropertyModelEdit.FontInfo.FontColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
