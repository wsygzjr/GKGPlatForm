...
{
    /// <summary>
    /// 将IconPositionEnum转换为Grid列索引
    /// </summary>
    public class IconPositionToColumnConverter : Avalonia.Data.Converters.IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is IconButtonMiscInfo.IconPositionEnum iconPosition)
            {
                return iconPosition switch
                {
                    ...
                    IconButtonMiscInfo.IconPositionEnum.Right => 1,
