...
{
    /// <summary>
    /// 将IconPositionEnum转换为文本的Grid行索引
    /// </summary>
    public class IconPositionToTextRowConverter : Avalonia.Data.Converters.IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is IconButtonMiscInfo.IconPositionEnum iconPosition)
            {
                return iconPosition switch
                {
                    ...
                    IconButtonMiscInfo.IconPositionEnum.Top => 1,
