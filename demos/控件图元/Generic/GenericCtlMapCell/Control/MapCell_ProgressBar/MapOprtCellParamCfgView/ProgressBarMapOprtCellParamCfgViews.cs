...
namespace GKG.Map.MapCell.Generic.ProgressBar.MapOprtCellParamCfgView
{
    internal static class ProgressBarOprtCellCfgJson
    {
    ...
    internal sealed class ColorPickerEditor : AControls.UserControl
    {
        ...
        private void UpdateColorPreview(string colorStr)
        {
            try
            {
                if (Color.TryParse(colorStr, out var color)) _colorPreview.Background = new SolidColorBrush(color);
            }
            catch { }
        }
    ...
    internal sealed class AppearanceInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ProgressBarOprtCellCfgJson.FromBytes<AppearanceInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class LayoutInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ProgressBarOprtCellCfgJson.FromBytes<LayoutInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class CommonInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ProgressBarOprtCellCfgJson.FromBytes<CommonInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            Orientation = temp.Orientation;
            Minimum = temp.Minimum ?? Minimum;
            Maximum = temp.Maximum ?? Maximum;
            Value = temp.Value ?? Value;
            IsIndeterminate = temp.IsIndeterminate;
    ...
    internal sealed class TextInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = ProgressBarOprtCellCfgJson.FromBytes<TextInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal abstract class ProgressBarOprtCellParamViewBase : AControls.UserControl
    {
    ...
    internal sealed class BrushInfoMapOprtCellParamView : ProgressBarOprtCellParamViewBase
    {
    ...
    internal sealed class AppearanceInfoMapOprtCellParamView : ProgressBarOprtCellParamViewBase
    {
    ...
    internal sealed class LayoutInfoMapOprtCellParamView : ProgressBarOprtCellParamViewBase
    {
    ...
    internal sealed class CommonInfoMapOprtCellParamView : ProgressBarOprtCellParamViewBase
    {
        public CommonInfoMapOprtCellParamView()
        {
            var root = CreateRoot();
            root.Children.Add(CreateRow("方向", CreateEnumComboBox<Orientation>(nameof(CommonInfoMapOprtCellParamViewModel.Orientation), 200)));
            ...
            root.Children.Add(CreateRow("值", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.Value), 120)));
            root.Children.Add(CreateCheckBox("不确定模式", nameof(CommonInfoMapOprtCellParamViewModel.IsIndeterminate)));
    ...
    internal sealed class TextInfoMapOprtCellParamView : ProgressBarOprtCellParamViewBase
    {
