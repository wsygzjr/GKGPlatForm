...
namespace GKG.Map.MapCell.Generic.Control.MapCell_Image.Objects
{
    ...
    public class ImageAppearanceInfo : MiniReactiveObject, IJsonValueConvert, IMPPropObjectValue
    {
        #region 静态字段

        public static readonly ImageAppearanceInfo Default = new ImageAppearanceInfo(1.0);
        public static readonly Guid Object_ID = new Guid("{C2B3D4E5-1002-4001-9001-000000000002}");
        ...
        public ImageAppearanceInfo() : this(1.0)
        {
        }

        public ImageAppearanceInfo(double opacity)
        {
            Opacity = opacity;
        }
        ...
        public void CopyFrom(ImageAppearanceInfo source)
        {
