...
namespace GKG.Map.MapCell.Generic.Stepper.MapOprtCellParamCfgView
{
    internal static class StepperOprtCellCfgJson
    {
    ...
    internal sealed class BrushInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        {
            var temp = StepperOprtCellCfgJson.FromBytes<BrushInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            BackColor = temp.BackColor ?? BackColor;
            BorderColor = temp.BorderColor ?? BorderColor;
            ForeColor = temp.ForeColor ?? ForeColor;
        }
        public byte[] ToBytes() => StepperOprtCellCfgJson.ToBytes(this);
    }
    ...
    internal sealed class AppearanceInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = StepperOprtCellCfgJson.FromBytes<AppearanceInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class LayoutInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = StepperOprtCellCfgJson.FromBytes<LayoutInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal sealed class CommonInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public string Increment { get => _increment; set => this.RaiseAndSetIfChanged(ref _increment, value); }

        private string _decimalPlaces = "0";
        public string DecimalPlaces { get => _decimalPlaces; set => this.RaiseAndSetIfChanged(ref _decimalPlaces, value); }
        ...
        public void FromBytes(byte[] data)
        {
            var temp = StepperOprtCellCfgJson.FromBytes<CommonInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
            LabelName = temp.LabelName ?? LabelName;
            Value = temp.Value ?? Value;
            Minimum = temp.Minimum ?? Minimum;
            Maximum = temp.Maximum ?? Maximum;
            Increment = temp.Increment ?? Increment;
            DecimalPlaces = temp.DecimalPlaces ?? DecimalPlaces;
    ...
    internal sealed class TextInfoMapOprtCellParamViewModel : ReactiveObject
    {
        ...
        public void FromBytes(byte[] data)
        {
            var temp = StepperOprtCellCfgJson.FromBytes<TextInfoMapOprtCellParamViewModel>(data);
            if (temp == null) return;
    ...
    internal abstract class StepperOprtCellParamViewBase : AControls.UserControl
    {
    ...
    internal sealed class BrushInfoMapOprtCellParamView : StepperOprtCellParamViewBase
    {
    ...
    internal sealed class AppearanceInfoMapOprtCellParamView : StepperOprtCellParamViewBase
    {
    ...
    internal sealed class LayoutInfoMapOprtCellParamView : StepperOprtCellParamViewBase
    {
    ...
    internal sealed class CommonInfoMapOprtCellParamView : StepperOprtCellParamViewBase
    {
        public CommonInfoMapOprtCellParamView()
        {
            var root = CreateRoot();
            root.Children.Add(CreateRow("标签文本", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.LabelName), 200)));
            root.Children.Add(CreateRow("当前值", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.Value), 80)));
            root.Children.Add(CreateRow("最小值", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.Minimum), 80)));
            root.Children.Add(CreateRow("最大值", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.Maximum), 80)));
            root.Children.Add(CreateRow("步长", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.Increment), 80)));
            root.Children.Add(CreateRow("小数位数", CreateTextBox(nameof(CommonInfoMapOprtCellParamViewModel.DecimalPlaces), 80)));
    ...
    internal sealed class TextInfoMapOprtCellParamView : StepperOprtCellParamViewBase
    {
