...
namespace GKG.Map.MapCell.Generic.PasswordBox
{
    ...
    /// 密码输入框图元设计时对象
    /// </summary>
    class MapCellPasswordBoxCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellPasswordBoxCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellPasswordBoxCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellPasswordBoxCtlObj(mapCellID, mapCellName, true);
        }
        ...
        {
            this.mapCellObj.PasswordBoxPropertyModelEdit.BrushInfo.ForeColor = textColor;
        }
        ...
        {
            this.mapCellObj.PasswordBoxPropertyModelEdit.BrushInfo.BorderColor = lineColor;
        }
        ...
        {
            this.mapCellObj.PasswordBoxPropertyModelEdit.BrushInfo.BackColor = fillColor;
        }
