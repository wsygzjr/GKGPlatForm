...
namespace GKG.Map.MapCell.Generic.RadioButton
{
    /// <summary>
    /// 单选框文本信息对象
    /// 包含字体蔟、字体颜色、字体大小、是否斜体、是否加粗
    /// </summary>
    [Serializable]
    [TypeConverter(typeof(ExpandableObjectConverter))]
    [ExpandableObjectDisplayMode(IsCategoryVisible = NullableBooleanType.No)]
    public class RadioButtonTextInfo : MiniReactiveObject, IJsonValueConvert, IMPPropObjectValue
    {
        #region 静态字段

        public static readonly RadioButtonTextInfo Default = new RadioButtonTextInfo(FontFamilyType.MicrosoftYaHei, Color.FromArgb(255, 0, 0, 0), 14, false, false);
        public static readonly Guid Object_ID = new Guid("{C1B2C3D4-5555-4AC8-BF66-281412CDE205}");
        ...
        public RadioButtonTextInfo()
            : this(FontFamilyType.MicrosoftYaHei, Color.FromArgb(255, 0, 0, 0), 14, false, false)
        {
        }

        public RadioButtonTextInfo(FontFamilyType fontFamilyType, Color fontColor, double fontSize, bool isItalic, bool isBold)
        {
        ...
        void IMPPropObjectValue.PopulateFromBaseValue(GriffinsBaseValue baseValue)
        {
            if (baseValue != null && baseValue.Val != null)
            {
                if (!(baseValue.Val is ObjectValue_Json))
                    throw new Exception("对象值不是RadioButtonTextInfo转换的");
