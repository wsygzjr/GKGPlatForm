...
{
    class MapCellComboBoxCtlDesigntime : IControlMapCellDesigntime
    {
        ...
        {
            mapCellObj = new MapCellComboBoxCtlObj(mapCellID, mapCellName,true);
        }
        ...
        {
            this.mapCellObj.SetComboBoxTextFont();
        }
