...
{
    class MapCellPanelCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellPanelCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellPanelCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellPanelCtlObj(mapCellID, mapCellName,true);
        }
