...
{
    class MapCellTextButtonCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellTextButtonCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellTextButtonCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellTextButtonCtlObj(mapCellID, mapCellName,true);
        }
        ...
        {
            this.mapCellObj.TextButtonPropertyModelEdit.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
