...
{
    class MapCellNumUpDownCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellNumUpDownCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellNumUpDownCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellNumUpDownCtlObj(mapCellID, mapCellName,true);
        }
        ...
        {
            this.mapCellObj.TextFont = textFont;
        }
        ...
        {
            this.mapCellObj.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
        ...
        {
            this.mapCellObj.SetNumUpDownTextFont();
        }
