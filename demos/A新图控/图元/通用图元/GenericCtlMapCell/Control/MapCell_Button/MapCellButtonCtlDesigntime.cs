...
{
    class MapCellButtonCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellButtonCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellButtonCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellButtonCtlObj(mapCellID, mapCellName,true);
        }
        ...
        {
            this.mapCellObj.ButtonPropertyModelEdit.TextFont= textFont;
        }
        ...
        {
            this.mapCellObj.ButtonPropertyModelEdit.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
