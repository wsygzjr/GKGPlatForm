...
{
    class MapCellObjectValueViewDesigntime : IControlMapCellDesigntime
    {
        private MapCellObjectValueViewObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellObjectValueViewDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellObjectValueViewObj(mapCellID, mapCellName,true);
        }
