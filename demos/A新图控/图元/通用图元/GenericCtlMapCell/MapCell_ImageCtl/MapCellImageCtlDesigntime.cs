...
{
    class MapCellImageCtlDesigntime : IControlMapCellDesigntime
    {
        private MapCellImageCtlObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellImageCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellImageCtlObj(mapCellID, mapCellName,true);
        }
