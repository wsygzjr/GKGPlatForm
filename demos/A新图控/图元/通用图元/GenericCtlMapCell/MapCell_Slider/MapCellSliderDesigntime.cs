...
{
    class MapCellSliderDesigntime : IControlMapCellDesigntime
    {
        private MapCellSliderObj mapCellObj;
        private IControlMapCellDesigntimeCallBack iCallBack;

        public MapCellSliderDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellSliderObj(mapCellID, mapCellName,true);
        }
