...
{
    class ImageListUiMapPropertyEditor : UiMapPropertyEditor
    {
        /// <summary>
        /// 值编辑样式（如果不重载，将返回None）
        /// </summary>
        ...
        public override Object EditPropertyValue(Object value)
        {
            ...
            if (value != null)
                formImages.ImageGroup = (GirffinsImageGroup)value;
            else
                formImages.ImageGroup = null;

            if (formImages.ShowDialog() == DialogResult.OK)
                return formImages.ImageGroup;
            else
                return value;
        }
        /// <summary>
