...
{
    class MapCellPressureCtlDesigntime : IFunctionalMapCellDesigntime
	{
        private MapCellPressureCtlObj mapCellObj;
        private IFunctionalMapCellDesigntimeCallBack iCallBack;

        public MapCellPressureCtlDesigntime(MapObjID mapCellID, string mapCellName)
        {
            mapCellObj = new MapCellPressureCtlObj(mapCellID, mapCellName, true);
        }
        ...
        {
            this.mapCellObj.PressurePropertyModelEdit.TextFont = textFont;
        }
        ...
        {
            this.mapCellObj.PressurePropertyModelEdit.TextColor = textColor;
        }
        /// <summary>
        /// 设置线条颜色
        /// </summary>
