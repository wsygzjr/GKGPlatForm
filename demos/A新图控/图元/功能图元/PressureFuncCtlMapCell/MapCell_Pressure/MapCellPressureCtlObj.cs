...
namespace Griffins.Map.PressureFuncCtlMapCell
{
	...
	public class PressurePropertyBindEditModel : FunctionalCellPropertyBindEditModel
	{
		...
		private PropertyBindInfo _pressureValue = new PropertyBindInfo(GriffinsBaseDataType.Decimal);
		/// <summary>
		/// 气压值
		/// </summary>
		[DisplayName("气压值")]
		...
		[Browsable(false)]
		public PropertyBindInfo PressureValue
		{
			get
			{
				return _pressureValue;
		...
		public void CopyFrom(PressurePropertyBindEditModel source)
		{
			...
			this.PressureValue.CopyFrom(source.PressureValue);
		}
	}
}
