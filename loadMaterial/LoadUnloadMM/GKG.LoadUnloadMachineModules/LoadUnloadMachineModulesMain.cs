...
namespace GKG
{
    namespace MM
    {
        ...
        [MachineModulesMngAttribute(LoadUnloadMachineModulesConst.MMModelStr, "LoadUnload")]
        class LoadUnloadMachineModulesMain : GriffinsPluginMngClass, IMachineModulesPlugin
        {
            ...
            string IMachineModulesMng.MMName => LoadUnloadMachineModulesConst.MMName;
            ...
            {
                return new LoadUnloadMMCmdExecutor(alias, factoryCfgInfo);
            }
        }
    }
}
