namespace GKG
{
    ...
    {
        /// <summary>
        /// StraightAxis 杩愬姩璁＄畻椹卞姩銆?        /// </summary>
        public class StraightAxisMotionCalculatorDriver : MotionCalculatorDriverBase
        {
            #region 私有字段

            private readonly StraightAxisCalculator calculator = new StraightAxisCalculator();

            #endregion

            #region 公有属性

            public override string DriverName => MotionCalculatorDriverNames.StraightAxis;
