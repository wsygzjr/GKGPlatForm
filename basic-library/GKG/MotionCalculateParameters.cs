...
namespace GKG
{
        ...
        public static MotionInstructionBase Create(MotionInstructionType motionInstructionType)
        {
            switch (motionInstructionType)
            {
                ...
                case MotionInstructionType.StopMove:
                    return new StopMoveInstruction();
                ...
                case MotionInstructionType.ManualPositionComparison:
                    return new ManualPositionComparisonInstruction();
                case MotionInstructionType.StopManualPositionComparison:
                    return new StopManualPositionComparison();
    ...
    public class ContinueMoveInstruction : MotionInstructionBase
    {
        ...
        protected override void fromBytes(byte[] data)
        {
            (this.Speed, this.Acceleration) = JsonObjConvert.FromJSonBytes<RelativeMoveInstruction>(data)
                is var temp ? (this.Speed, this.Acceleration) : ((double)0, (double)0);
        }
    ...
    public class RelativeMoveInstruction : MotionInstructionBase
    {
        ...
        /// 位移距离
        /// </summary>
        public AxisConstantValues Distance {  get; set; }


        protected override void fromBytes(byte[] data)
        {
            (this.Speed, this.Acceleration, this.Distance) = JsonObjConvert.FromJSonBytes<RelativeMoveInstruction>(data)
                is var temp ? (this.Speed, this.Acceleration, this.Distance) : ((double)0, (double)0, new AxisConstantValues());
        }
    ...
    /// 停止连续运动指令。
    /// </summary>
    public class StopMoveInstruction : MotionInstructionBase
    {
        public int LogicAxis { get; set; }

        protected override void fromBytes(byte[] data)
        {
            LogicAxis = JsonObjConvert.FromJSonBytes<StopMoveInstruction>(data)?.LogicAxis ?? 0;
        }

        protected override MotionInstructionType getInstructionType()
        {
            return MotionInstructionType.StopMove;
        }
    ...
    public class ManualPositionComparisonInstruction : MotionInstructionBase
    {
        public int[] Channel { get; set; }
        public short StartLevel { get; set; }
        public int PulseOutputMode { get; set; }
        ...
        protected override void fromBytes(byte[] data)
        {
            var source = JsonObjConvert.FromJSonBytes<ManualPositionComparisonInstruction>(data);
            this.Channel = source.Channel;
            this.StartLevel = source.StartLevel;
            this.PulseOutputMode = source.PulseOutputMode;
        ...
        protected override MotionInstructionType getInstructionType()
        {
            return MotionInstructionType.ManualPositionComparison;
        }
    ...
    public class StopManualPositionComparison : MotionInstructionBase
    {
        protected override void fromBytes(byte[] data)
        {
        ...
        protected override MotionInstructionType getInstructionType()
        {
            return MotionInstructionType.StopManualPositionComparison;
        }
