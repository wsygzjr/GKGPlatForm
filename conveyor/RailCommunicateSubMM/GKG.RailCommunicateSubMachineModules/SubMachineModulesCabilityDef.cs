...
namespace GKG
{
	namespace SubMM
	{
		...
		{
            ImeCompEventDefInfoList ISubMachineModulesCabilityDef.Events => RailCommunicateSubMachineModulesConst.CompEvents;

            ImeCompMethodDefInfoList ISubMachineModulesCabilityDef.Methods => RailCommunicateSubMachineModulesConst.CompMethods;
